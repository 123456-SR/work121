...
<body>
    ...
    <div class="footer-info">
        ...
        <span>计算：<input type="text" name="calculator" style="width: 100px; border-bottom: 1px solid black;"></span>
    ...
    <script>
        function generatePdf() {
            ...
            form.action = '/api/pdf/light_dynamic_penetration_record/generate';
            form.target = '_blank';
            form.submit();
        }
        ...
        function previewPdf() {
            var form = document.getElementById('pdfForm');
            form.action = '/api/pdf/light_dynamic_penetration_record/preview';
            form.target = '_blank';
            form.submit();
        }
    </script>
