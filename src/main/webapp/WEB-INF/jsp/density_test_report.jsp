...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" name="testMethod"></td>
        </tr>
        <tr>
            <td class="label">检测依据</td>
            <td colspan="4"><input type="text" name="testBasis"></td>
        ...
        <tr>
            ...
            <td colspan="7" class="left-align"><input type="text" name="designIndex"></td>
        </tr>
        <tr>
            <td class="label">检测结果</td>
            <td colspan="7" class="left-align"><input type="text" name="testResult"></td>
        </tr>
        ...
        <tr>
            ...
            <td></td> <!-- Empty cell to match column count of 8 -->
        </tr>
        <% 
        } 
        %>
        ...
        <tr>
            ...
            <td colspan="7" class="left-align" style="height: 100px; vertical-align: top;">
