 ...
 * 灌水法检测实体类
 */
public class WaterReplacement extends BusinessEntity {
    ...
    public String getPitVolume() {
        return pitVolume;
    }

    public void setPitVolume(String pitVolume) {
        this.pitVolume = pitVolume;
    }
