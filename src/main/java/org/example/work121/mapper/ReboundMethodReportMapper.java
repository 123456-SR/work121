...
public interface ReboundMethodReportMapper {
    ...
    @Select("SELECT " +
            ...
            "FROM T_REBOUND_METHOD_REPORT " +
            "WHERE ENTRUSTMENT_ID = #{entrustmentId}")
    ReboundMethodReport selectByEntrustmentId(@Param("entrustmentId") String entrustmentId);

    @Insert("INSERT INTO T_REBOUND_METHOD_REPORT (ID, ENTRUSTMENT_ID, DATA_JSON, REVIEW_SIGNATURE_PHOTO, INSPECT_SIGNATURE_PHOTO, APPROVE_SIGNATURE_PHOTO) " +
    ...
    @Update("UPDATE T_REBOUND_METHOD_REPORT SET " +
            "DATA_JSON = #{dataJson}, " +
