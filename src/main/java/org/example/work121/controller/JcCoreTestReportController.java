...
@RestController
@RequestMapping("/api/jc-core-test-report")
@CrossOrigin(origins = "*")
public class JcCoreTestReportController {

    private static final Logger logger = LoggerFactory.getLogger(JcCoreTestReportController.class);
