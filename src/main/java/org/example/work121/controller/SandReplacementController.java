...
@CrossOrigin(origins = "*")
public class SandReplacementController {

    private static final Logger logger = LoggerFactory.getLogger(SandReplacementController.class);
    ...
    public Map<String, Object> getByEntrustmentId(@RequestParam String entrustmentId) {
        ...
        try {
            java.util.List<SandReplacement> list = service.getByEntrustmentId(entrustmentId);
    ...
    @PostMapping("/save")
    public Map<String, Object> save(@RequestBody SandReplacement entity) {
        Map<String, Object> result = new HashMap<>();
        try {
            service.save(entity);
            result.put("success", true);
    ...
    public Map<String, Object> getReportByEntrustmentId(@RequestParam String entrustmentId) {
        Map<String, Object> result = new HashMap<>();
        try {
            SandReplacementReport entity = service.getReportByEntrustmentId(entrustmentId);
            if (entity != null) {
                result.put("success", true);
                result.put("data", entity);
            } else {
    ...
    public Map<String, Object> saveReport(@RequestBody SandReplacementReport entity) {
        Map<String, Object> result = new HashMap<>();
        try {
