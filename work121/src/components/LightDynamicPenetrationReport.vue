<template>
  <div class="lightDynamicPenetration-container">
    ...
    <div class="company-info" style="display: block; margin-top: 5px; font-size: 12px;">
...
const openClientPdfPreview = () => {
  ...
  const container = pdfForm.value.closest('.lightDynamicPenetrationReport-container')
  if (!container) return
...
<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      .pdf-preview.lightDynamicPenetrationReport-container { width: 100%; height: 100%; margin: 0; padding: 0; box-sizing: border-box; display: flex; flex-direction: column; }
...
<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      .pdf-content { position: absolute; left: 0; top: 0; transform-origin: top left; }
      .pdf-preview.lightDynamicPenetration-container { width: 198mm; height: 285mm; max-width: 198mm; min-width: 0; margin: 0; padding: 0; box-sizing: border-box; display: flex; flex-direction: column; }
      .pdf-preview { overflow: visible; }
      .pdf-preview * { page-break-inside: avoid; break-inside: avoid; }
