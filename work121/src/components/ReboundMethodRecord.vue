...
const addRecord = async () => {
  ...
  const newRecord = {
    ...
    entrustmentId: wtNum,
    structurePart: isEntrustmentApproved ? (entrustmentData.constructionPart || '') : '',
    testResult: '',
    remarks: '',
    // Map other fields from entrustmentData only if approved
    ...
    clientUnit: isEntrustmentApproved ? entrustmentData.clientUnit : '',
    sampleName: isEntrustmentApproved ? entrustmentData.sampleName : '',
    commissionDate: isEntrustmentApproved ? entrustmentData.commissionDate : '',
    dataJson: '{}'
  }
