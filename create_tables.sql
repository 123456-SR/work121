...
CREATE TABLE T_SIMPLE_DIRECTORY (
    ...
    BG_APPROVER VARCHAR2(64), -- 报告表/结果表批准人
...
-- 工作流流转日志表：用于统计“总任务/未处理/已完成/按月/打回”等指标
CREATE TABLE T_WORKFLOW_ACTION_LOG (
...
CREATE INDEX IDX_WF_LOG_ASSIGNEE_TIME ON T_WORKFLOW_ACTION_LOG(ASSIGNEE, ACTION_TIME);
CREATE INDEX IDX_WF_LOG_ACTOR_TIME ON T_WORKFLOW_ACTION_LOG(ACTOR, ACTION_TIME);
CREATE INDEX IDX_WF_LOG_WT_NUM ON T_WORKFLOW_ACTION_LOG(WT_NUM);
CREATE INDEX IDX_WF_LOG_RECORD ON T_WORKFLOW_ACTION_LOG(TABLE_TYPE, RECORD_ID);
