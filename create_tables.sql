...
CREATE TABLE T_REBOUND_METHOD (
    ...
    CONCRETE_GRADE VARCHAR2(64),
    MOLDING_DATE DATE,
    AGE VARCHAR2(64),
    INSTRUMENT_MODEL VARCHAR2(128),
    CALIBRATION_NO VARCHAR2(128),
    ZONE_COUNT VARCHAR2(64),
    POURING_DIRECTION VARCHAR2(64),
    TEST_ANGLE VARCHAR2(64),
    PUMPING_METHOD VARCHAR2(64),
    PUMPING VARCHAR2(64),
    DESIGN_STRENGTH VARCHAR2(64),
    CARBONATION_DEPTH VARCHAR2(64),
